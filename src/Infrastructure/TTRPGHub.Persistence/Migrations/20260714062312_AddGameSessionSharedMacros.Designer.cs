...
namespace TTRPGHub.Migrations
{
    ...
    [Migration("20260714062312_AddGameSessionSharedMacros")]
    partial class AddGameSessionSharedMacros
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TTRPGHub.Entities.Character", b =>
                {
                    ...
                    b.PrimitiveCollection<List<Guid>>("CoOwnerIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid[]")
                    ...
                    b.Property<string>("SelectedFeatsJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("selected_feats_json");
            ...
            modelBuilder.Entity("TTRPGHub.Entities.GameSession", b =>
                {
                    ...
                    b.Property<bool>("AutomaticBonusProgression")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("automatic_bonus_progression");
                    ...
                    b.Property<string>("EncounterTableJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("encounter_table_json");
                    ...
                    b.Property<bool>("FreeArchetype")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("free_archetype");

                    b.Property<bool>("GradualAbilityBoosts")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("gradual_ability_boosts");
                    ...
                    b.PrimitiveCollection<List<Guid>>("SharedMacroIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid[]")
                    ...
                    b.Property<bool>("StaminaVariant")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("stamina_variant");
            ...
            modelBuilder.Entity("TTRPGHub.Entities.Macro", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TTRPGHub.Entities.Moderation.ModerationLogEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("moderation_log_entries", (string)null);
                });
            ...
            modelBuilder.Entity("TTRPGHub.Entities.Ratings.SessionReview", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("SessionId", "ReviewerId", "RevieweeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("TTRPGHub.Entities.TicketComment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("TTRPGHub.Entities.Ratings.SessionReview", b =>
                {
                    b.HasOne("TTRPGHub.Entities.User", "Reviewee")
                        .WithMany()
                        .HasForeignKey("RevieweeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TTRPGHub.Entities.User", "Reviewer")
                        .WithMany()
