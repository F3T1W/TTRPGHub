...
// N.9 — как и хазарды (N.1), транспорт не проходит через Pf2eLocaleService: нет
// предзагруженного английского набора, RU — единственный источник контента.
public partial class Vehicles
{
    [Inject] private IApiClient Api { get; set; } = default!;
    [Inject] private NavigationManager Nav { get; set; } = default!;

    private Pf2eVehiclePagedResult? _result;
    ...
    private async Task LoadAsync()
    {
        ...
        try
        {
            ...
            _result = await Api.GetPf2eVehiclesAsync(
